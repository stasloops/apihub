    ...
    return (
        <div className={styles.endpoints__menu_create_form}>
            <div className={styles.endpoints__menu_create_form_top}>
                <input value={status} onChange={e => changeStatus(e)} placeholder='Code' className={`${styles.endpoints__menu_create_input} ${styles.endpoints__menu_create_input_code}`} />
                <input value={message} onChange={e => changeMessage(e)} placeholder='Message' className={styles.endpoints__menu_create_input} />
                <span onClick={addResponse} className={styles.endpoints__menu_create_button}>+</span>
